<div style="margin:10px;" ng-controller="pendingUsersController" ng-cloak>
    <div class="card"  ng-show="userInfoTable">
        ...
        <div class="card-content with-padding">
            <i class="fa fa-users green-text"></i> PENDING ADMINISTRATORS [ {{ results.length }} ]
        ...
        <div class="card-content with-padding">
            <table class="highlight bordered striped">
                ...
                <tr dir-paginate="user in results =  (pendingUsers  | filter:searchResult)| orderBy: 'created_at' | itemsPerPage:10 "
                    ...
                    <td>
                        <button class="btn chip blue lighten-2 white-text" ng-click="approveUser(user)"><i class="fa fa-check"></i> </button>
                        <button class="btn chip grey lighten-1 white-text"  ng-click="ignoreUser(user)"> <i class="fa fa-eye"></i></button>
                        <button class="btn chip orange darken white-text" ng-click="deleteUser(user)"> <i class="fa fa-trash-o" ></i></button>
                    </td>
