...
Route::group(['middleware' => ['auth', 'gcUserStatus', 'gcAdmin', 'logs']], function () {
    ...
    Route::post('/client/validate', 'ClientController@bulkValidate')->name('bulkValidate');
    ...
    Route::get('/client/size/{len}', 'ClientController@ajaxRequest');
    ...
    Route::get('/disbursements/approvedata', 'DisbursementsController@submitDisbursements')->name('approvedata');
